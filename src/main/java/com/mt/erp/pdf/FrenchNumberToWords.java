/*
 * https://www.rgagnon.com/javadetails/java-0426.html
 * https://www.developpez.net/forums/d274731/java/general-java/api-standards-tierces/convertir-nombre-lettres/
 */
...
public class FrenchNumberToWords {
  ...
  public static void main(String[] args) {
	  /*
	System.out.println("*** " + FrenchNumberToWords.convert((int)13.069)+" dinars");
    float x = 13.690f;
    long dinarts = (int) x;
    long millimes = Math.round((x - dinarts) * 1000);
    System.out.println("intPart= " + dinarts);    
    System.out.println("decimapPart= " + millimes);  
    
    System.out.println("*** " + FrenchNumberToWords.convert(690));
